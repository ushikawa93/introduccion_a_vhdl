...
MEM_0 := nios_system_program_memory
$(MEM_0)_NAME := program_memory
...
$(MEM_0)_HIERARCHICAL_PATH := program_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: program_memory
program_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
